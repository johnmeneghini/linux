...
extern int qla29xx_load_risc(scsi_qla_host_t *, uint32_t *);
...
extern void qla24xx_report_id_acquisition(scsi_qla_host_t *, void *);
...
cont_a64_entry_t *qla2x00_prep_cont_type1_iocb(scsi_qla_host_t *vha,
		struct req_que *que);
cont_a64_entry_ext_t *qla2900_prep_cont_type1_iocb(scsi_qla_host_t *vha,
		struct req_que *req);
...
extern int qla29xx_flash_block_read(scsi_qla_host_t *, dma_addr_t,
				    uint32_t, uint32_t,
				    uint16_t, uint16_t);
extern int qla29xx_flash_block_write(scsi_qla_host_t *, dma_addr_t,
				     uint32_t, uint32_t,
				     uint16_t, uint16_t);
...
int qla_mailbox_passthru(scsi_qla_host_t *vha, uint16_t *mbx_in,
			 uint16_t *mbx_out);
extern void * qla29xx_read_optrom_data(struct scsi_qla_host *,
				       uint16_t, uint16_t, void *,
				       uint32_t, uint32_t);
extern int qla29xx_write_optrom_data(struct scsi_qla_host *,
				     uint16_t, uint16_t, void *,
				     uint32_t, uint32_t);
